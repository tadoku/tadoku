...
These gates cover the supported DevCLI workflow after Tilt retirement. Repeat
them for changes to routing or synchronization; publish CLI releases only after
their live gates pass. Removing repository files never authorizes live teardown.
