...
function LogForm({existing}:{existing?:SampleLog}){
  ...
  return <section><header className="page-header"><Link className="text-link page-back-link" to={detailHref}>{existing?'Back to log':'Your activity log'}</Link><h1 className="paper-type-page">{existing?'Edit activity':'Log activity'}</h1><p className="page-lead">Record what you read or listened to. Every little bit counts.</p></header>
