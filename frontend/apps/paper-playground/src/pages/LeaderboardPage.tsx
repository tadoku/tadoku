        ...
        <section className="standings-sheet" aria-label="Standings">
          <div className="standings-context">
            ...
            <div className="standings-context__actions">
              ...
              {!isError && !isEmpty ? <Button ref={filtersToggle} variant="ghost" className="standings-filter-toggle" aria-expanded={filtersOpen} aria-controls={filtersId} onClick={() => setFiltersOpen(!filtersOpen)} trailingIcon={<ChevronDownIcon className="paper-icon-compact" />}>Filters{appliedFilters.length ? ` (${appliedFilters.length})` : ''}</Button> : null}
            </div>
          </div>
