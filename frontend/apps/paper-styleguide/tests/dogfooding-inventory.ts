...
export const DOGFOODING_DEBT: readonly DogfoodingDebt[] = [
  ...
  {
    key: 'src/styles/controls.css:surface-style:.canvas-controls select',
    context: 'Preview preference control surface',
    destination: 'Paper Select recipe',
  },
  {
    key: 'src/styles/shell-layout.css:surface-style:.canvas-viewport-button',
    context: 'Preview viewport action surface',
    destination: 'Paper Tabbar or segmented-choice recipe',
  },
  {
    key: 'src/styles/navigation.css:surface-style:.catalogue-nav__link--active',
    context: 'Current catalogue navigation item surface',
    destination: 'Paper Sidebar current-item recipe',
  },
  {
    key: 'src/styles/navigation.css:surface-style:.catalogue-nav__link:hover',
  ...
  {
    key: 'src/styles/workbench.css:surface-style:.component-workbench',
    context: 'Examples workbench outer surface',
    destination: 'Paper Surface',
  },
  {
    key: 'src/styles/workbench.css:surface-style:.component-workbench__fixture-select select',
    context: 'Fixture picker surface',
    destination: 'Paper Select recipe',
  },
  {
    key: 'src/styles/workbench.css:surface-style:.component-workbench__tabs button:hover',
    context: 'Workbench tab hover surface',
    destination: 'Paper Tabbar hover recipe',
  },
  {
    key: 'src/styles/documents.css:surface-style:.design-history__links a',
  ...
  {
    key: 'src/styles/canvas-frame.css:surface-style:.example-canvas',
    context: 'Isolated preview content surface',
    destination: 'Paper Surface without its own enclosing border',
  },
  {
    key: 'src/styles/canvas.css:surface-style:.example-canvas iframe',
    context: 'Isolated preview document surface',
    destination: 'Paper isolated-preview frame recipe',
  },
  {
    key: 'src/styles/canvas.css:surface-style:.example-canvas__stage',
    context: 'Isolated preview stage surface',
    destination: 'Paper Surface without its own enclosing border',
  },
  {
    key: 'src/styles/overlays.css:surface-style:.mobile-nav-backdrop',
  ...
  {
    key: 'src/styles/shell-layout.css:surface-style:.mobile-nav-trigger',
    context: 'Responsive catalogue trigger surface',
    destination: 'Paper Button recipe',
  },
  {
    key: 'src/styles/workbench.css:surface-style:.paper-fixture-stage',
    context: 'Fixture document canvas',
    destination: 'Paper Surface without its own enclosing border',
  },
  {
    key: 'src/styles/overlays.css:surface-style:.search-backdrop',
    context: 'Search dialog scrim',
    destination: 'Paper Modal',
  },
  {
    key: 'src/styles/controls.css:surface-style:.search-field input',
  ...
  {
    key: 'src/styles/shell-layout.css:surface-style:.shell-icon-button',
    context: 'Shell icon-only action surface',
    destination: 'Paper Button icon-only recipe',
  },
  {
    key: 'src/styles/shell-layout.css:surface-style:.shell-search-trigger',
