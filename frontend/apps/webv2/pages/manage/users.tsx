...
function RoleBadge({ role }: { role?: string }) {
  if (role === 'admin') {
    return (
      <span className="tag bg-purple-100 text-purple-800">Admin</span>
    )
  }
  if (role === 'banned') {
    return (
      <span className="tag bg-red-100 text-red-800">Banned</span>
    )
  }
  return (
    <span className="tag bg-slate-100 text-slate-600">User</span>
  )
}
