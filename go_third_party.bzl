...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:sSm1RGQzUTr23yR6SS7RIBBLV8V2bFIu07z4nyVOwmI=",
    ...
    go_repository(
        ...
        sum = "h1:Qf4HiqfvmB7zS6scsmNgTLmByHbq8n9RTF39v+TzP7A=",
        version = "v0.0.0-20200824123100-0b889c03f102",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IK6yirB4X7wpKyFSikWiT++nZsyIxGAAgNEv3fEGuls=",
    ...
    go_repository(
        ...
        sum = "h1:1c6xmkNiu6Jnr6AKGM91GGNsfU+nPNFvw9BZFSo0E+c=",
        version = "v0.0.0-20201026212402-0724c46b320c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:KbgF4MRmTDGp+4XissYZPZsdo0wS9f1pfYmRNFE2R0I=",
        version = "v0.0.0-20201007170849-eb1350a75164",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:k14X1HVvImFGx96RHryyftNFd9OAW3YtCg6OeO262yo=",
        version = "v0.0.0-20200918131355-0a33824f23a2",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_creasty_configo",
        importpath = "github.com/creasty/configo",
        sum = "h1:SZh25gZhbFC/XxgF3k22M+LtkOMOLgWCoWEeJtZA3pA=",
        version = "v0.0.0-20170711121124-288b7e8980d2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:6On4TAD6V33/QlE6Y5l0A4KngRzYrUQ7bgPsDrFrtQo=",
        version = "v0.1.4",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_davidhuie_gomigrate",
        importpath = "github.com/DavidHuie/gomigrate",
        sum = "h1:pfeJevnIXt4KJShhkTp8uRU0evDkRaFkAdmaNmzHMIQ=",
    ...
    go_repository(
        ...
        sum = "h1:DCP6cbtT+Zu++K6evHOJzSgA2115cPMuCx0xg55q1EQ=",
        version = "v4.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Aof83YILRs2Vx3GhHqlvvfyx1asRJKMFIMeVlHsZKtI=",
        version = "v0.8.15",
    )
    go_repository(
        name = "com_github_microsoft_hcsshim_test",
        importpath = "github.com/Microsoft/hcsshim/test",
        sum = "h1:sqPBuX6WumurdHaSRbS8xyyyP8Rf7kUpLUlJaN7rztw=",
        version = "v0.0.0-20201218223536-d3e5debf77da",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_srvc_fail",
        importpath = "github.com/srvc/fail",
        sum = "h1:NyG9nEm+AG/5RcwtmhsjCAwFgycb/MRGe3X78BR+w2U=",
    ...
    go_repository(
        ...
        sum = "h1:pv3V0NlNSh5Q6AX/StwGLBjcLS7UN4m4Gq+V+uSecqM=",
        version = "v0.0.0-20210502124803-cbf565b21d1e",
    )
    ...
    go_repository(
        ...
        sum = "h1:Si4U+UcgJzya9kpiEUJKQvjr512OLli+gL4poHrz93U=",
