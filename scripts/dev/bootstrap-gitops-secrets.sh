...
for namespace in tdk-dev-data tdk-dev-kratos tdk-dev-keto tdk-dev-oathkeeper tdk-dev-tadoku-api tdk-dev-immersion-api tdk-dev-content-api tdk-dev-profile-api; do
...
for service in tadoku-api immersion-api content-api profile-api; do
