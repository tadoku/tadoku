...
var operationAccess = map[string]accessLevel{
	...
	"ImmersionLogContestRegistrationUpdate":              accessAuthenticated,
	"ImmersionLogDeleteByID":                             accessAuthenticated,
	"ImmersionContestModerationDetachLog":                accessAuthenticated,
...
var operationFixtures = map[string]string{
	...
	"ImmersionLogContestRegistrationUpdate": "ImmersionLogContestRegistrationUpdate",
	"ImmersionLogDeleteByID":                "ImmersionLogDeleteByID",
	"ImmersionContestModerationDetachLog":   "ImmersionContestModerationDetachLog",
