...
update contests set owner_user_id='44444444-4444-4444-8444-444444444444', owner_user_display_name='User Two' where id='f0000000-0000-4000-8000-000000000001';

update users set deletion_locked_at='2026-09-01' where id='11111111-1111-4111-8111-111111111111';
