...
update logs set score_source='amount', score_rule_set_id=(select id from scoring_rule_sets order by id limit 1), score_rule_ids='{11111111-1111-4111-8111-111111111111}', score_rates='{2.5}' where id='d1111111-1111-4111-8111-111111111111';
