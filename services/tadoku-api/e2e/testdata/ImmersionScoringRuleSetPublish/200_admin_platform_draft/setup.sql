...
insert into scoring_rules (id,rule_set_id,priority,stackable,activity_id,score_source,rate) values
 ('bbbbbbbb-bbbb-4bbb-8bbb-000000000099','aaaaaaaa-aaaa-4aaa-8aaa-000000000002',1,false,1,'amount',9);
...
insert into contests (id,owner_user_id,owner_user_display_name,"private",contest_start,contest_end,registration_end,title,language_code_allow_list,activity_type_id_allow_list,official,created_at,updated_at) values
 ('f0000000-0000-4000-8000-000000000001','11111111-1111-4111-8111-111111111111','Reader One',false,'2026-09-13','2026-09-30','2026-09-20','Owned','{eng}','{1,5}',false,'2026-01-01','2026-01-01'),
 ('f0000000-0000-4000-8000-000000000002','22222222-2222-4222-8222-222222222222','Other Owner',false,'2026-09-13','2026-09-30','2026-09-20','Other','{eng}','{1}',false,'2026-01-01','2026-01-01');
insert into scoring_rule_sets (id,scope,contest_id,version,status,mode,fallback_rule_set_id,created_at,published_at) values
 ('cccccccc-cccc-4ccc-8ccc-000000000001','contest','f0000000-0000-4000-8000-000000000001',1,'published','override','aaaaaaaa-aaaa-4aaa-8aaa-000000000001','2026-03-01','2026-03-02'),
