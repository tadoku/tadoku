...
insert into contests (id, owner_user_id, owner_user_display_name, private, contest_start, contest_end, registration_end, title, activity_type_id_allow_list, official, created_at, updated_at, deleted_at) values ('f0000000-0000-4000-8000-000000000004', '99999999-9999-4999-8999-999999999999', 'stale', false, '2026-12-31', '2027-01-02', '2027-01-02', 'History 4', '{1,2}', false, '2026-01-01', '2026-01-01', null);
insert into contest_registrations (id, contest_id, user_id, language_codes, deleted_at) values ('eeeeeeee-eeee-4eee-8eee-000000000004', 'f0000000-0000-4000-8000-000000000004', '11111111-1111-4111-8111-111111111111', '{eng}', null);

insert into contests (id, owner_user_id, owner_user_display_name, private, contest_start, contest_end, registration_end, title, activity_type_id_allow_list, official, created_at, updated_at, deleted_at) values ('f0000000-0000-4000-8000-000000000005', '99999999-9999-4999-8999-999999999999', 'stale', false, '2027-01-01', '2027-01-31', '2027-01-31', 'History 5', '{1,2}', false, '2026-01-01', '2026-01-01', null);
insert into contest_registrations (id, contest_id, user_id, language_codes, deleted_at) values ('eeeeeeee-eeee-4eee-8eee-000000000005', 'f0000000-0000-4000-8000-000000000005', '11111111-1111-4111-8111-111111111111', '{eng}', null);
