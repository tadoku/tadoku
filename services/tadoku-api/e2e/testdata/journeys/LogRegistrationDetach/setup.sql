...
-- Distinct timestamps exercise the declared order without assuming a tie-breaker.
update logs set created_at='2026-09-01 01:00:00' where id='d1111111-1111-4111-8111-111111111111';
update logs set created_at='2026-09-01 02:00:00' where id='d2222222-2222-4222-8222-222222222222';
update logs set created_at='2026-09-01 03:00:00' where id='d3333333-3333-4333-8333-333333333333';
